class kelola_debitur():
    def _init_(self, nama, ktp, limit_pinjaman):
        self.nama = nama
        self.__ktp = ktp
    ...
    try:
        ...
        while status:
            ...
            if not ktp_terdaftar:
                ...
                debitur_baru = kelola_debitur(nama, ktp, limit_pinjaman)
...
class menu_pinjaman(kelola_debitur):
...
user1 = kelola_debitur("sova", 123, 4500000)
user2 = kelola_debitur("sage", 344, 2000000)
user3 = kelola_debitur("yoru", 555, 1500000)
user4 = kelola_debitur("deadlock", 255, 7000000)
user5 = kelola_debitur("raze", 765, 4000000)
